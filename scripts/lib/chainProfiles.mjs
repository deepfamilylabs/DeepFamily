...
const profile = ({
  ...
  deepFreeze({
    ...
    acceptance: {
      ...
      wrapperTokenEnvironmentName: `DEEPFAMILY_${acceptance.envPrefix}_WRAPPER_TOKEN`,
    ...
    mainnet: {
      ...
      planApprovalSignaturesEnvironmentName: `${mainnet.envPrefix}_PLAN_APPROVAL_SIGNATURES`,
      ...
      testnetReleaseReportEnvironmentName: `${mainnet.envPrefix}_TESTNET_RELEASE_REPORT`,
