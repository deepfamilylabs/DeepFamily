        ...
        <div className={`absolute right-0 z-[9999] mt-2 w-64 origin-top-right rounded-xl shadow-xl backdrop-blur-xl transition-all duration-200 ${
          ...
          <div className="py-1">
            ...
            <NavLink
              ...
              className={({ isActive }) => `flex items-center gap-3 w-full px-4 py-3 text-xs font-medium rounded-lg transition ${
                isActive
            ...
            >
              <Lock size={18} className={`${isHomePage ? 'text-blue-500 dark:text-blue-400' : 'text-indigo-500 dark:text-indigo-400'}`} />
