            ...
            return (
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  {/* Status dot */}
                  <div
                    className={`absolute -top-1 -right-1 w-3.5 h-3.5 rounded-full border-2 border-white dark:border-gray-900 ${config.dot}`}
                  >
                    {isActive && (
                      <div
                ...
                <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center">
                  {isLoading ? (
                    ...
                    <div
                      className={`w-7 h-7 rounded-full bg-gradient-to-br ${config.gradient} flex items-center justify-center shadow-md ${config.shadow}`}
                    >
