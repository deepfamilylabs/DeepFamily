                ...
                <div className="flex flex-col gap-2">
                  <div className="relative w-full" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-slate-500 transition-transform duration-200 ${isNetworkDropdownOpen ? "rotate-180" : ""}`}
                      />
                    </button>
