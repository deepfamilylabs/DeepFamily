              ...
              <div className="flex items-start gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0">
                  ...
                  <div
                    ...
                    className="relative max-w-[56vw] sm:max-w-xs md:max-w-md overflow-hidden"
                  >
                  ...
                  <div className="flex flex-wrap items-center gap-1.5 text-xs text-gray-600 dark:text-gray-400">
                    {genderText && (
                      <span className="whitespace-nowrap font-medium">{genderText}</span>
                    )}
                    {isMinted(person) && (
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {chunksCount > 0 && (
                          <span className="text-xs text-gray-500 dark:text-gray-400 font-medium px-2 py-0.5 bg-gray-100 dark:bg-gray-800 rounded-full">
                            {t(
                              "storyChunksModal.chunksCount",
                              "{{count}} chunks, {{length}} bytes",
                              {
                                count: chunksCount,
                                length: lengthBytes,
                              },
                        ...
                        {storyData.chunks.map((chunk) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <span
                                  className={`mt-0.5 transition-colors ${isExpanded ? "text-blue-600 dark:text-blue-400" : "text-gray-400 dark:text-gray-500"}`}
                                >
                                  {isExpanded ? (
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-2">
                                      <span
                                        className={`text-[15px] font-semibold ${isExpanded ? "text-blue-900 dark:text-blue-100" : "text-gray-900 dark:text-gray-100"}`}
                                      >
                                        #{chunk.chunkIndex}
                                      </span>
                                      {(() => {
                                  ...
                                  <div
                                    className={`text-[13px] leading-relaxed ${isExpanded ? "text-gray-800 dark:text-gray-200 whitespace-pre-wrap" : "text-gray-700 dark:text-gray-300 line-clamp-2"}`}
                                  >
