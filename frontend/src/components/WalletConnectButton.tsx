...
export default function WalletConnectButton({ 
  ...
  // Wrong network indicator - only Conflux eSpace networks are supported
    ...
    <div className={`inline-flex items-center gap-2 min-w-0 ${className}`}>
      {isWrongNetwork && (
        <button
          ...
          className={`group flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-medium cursor-pointer transition-all hover:scale-105 ${
            isHomePage
        ...
        >
          ...
          <RefreshCw className={`w-3 h-3 flex-shrink-0 group-hover:rotate-180 transition-transform duration-300 ${
