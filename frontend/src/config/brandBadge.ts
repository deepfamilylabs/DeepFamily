...
const BADGE_CONFIGS: Record<BadgeType, BadgeConfig | null> = {
  ...
  preview: {
    text: "PREVIEW",
    className:
      "bg-gradient-to-r from-violet-400 to-indigo-500 dark:from-violet-500 dark:to-indigo-600",
    colorClasses: "text-white shadow-sm",
  },
  demo: {
    text: "DEMO",
  ...
  mainnet: {
    text: "MAINNET",
    className:
      "bg-gradient-to-r from-emerald-400 to-teal-500 dark:from-emerald-500 dark:to-teal-600",
    colorClasses: "text-white shadow-sm",
  },
  none: null,
};
