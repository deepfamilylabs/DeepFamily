...
export const ERROR_SELECTOR_MAP: Record<string, string> = {
  ...
  "0x94e00e4e": "StoryAlreadyInitialized",
  "0xb5dd8eec": "InvalidStoryAuthor",
  ...
  "0x5bb5c7d1": "InvalidGovernanceDelay",
  "0x49b8423a": "InvalidGovernanceMultisig",
  "0x666b4c14": "InvalidTreasuryToken",
  "0x7ed64517": "InvalidTreasuryRecipient",
  "0x98dce1a9": "VerifierRouteNotSet",
  "0x2c90aac2": "VerifierRouteAlreadySet",
  "0x3c3397a6": "InvalidCircuitId",
  ...
  "0xe3b4805d": "MetadataAlreadyStored",
  "0x6f7854ef": "StoreFailed",
  ...
  "0x28926207": "DirectNativeCurrencyNotAccepted",
  "0x1fcb6b91": "StoryAlreadySealed",
  "0xfb8cd7ea": "StoryNotFound",
  "0xdaffd8a5": "MustBeNFTHolder",
  "0x081f37d2": "OnlyDeepFamilyContract",
  "0x39617acd": "InvalidDeepFamilyContract",
  "0xf66efc2d": "InvalidTokenBinding",
  "0x11e28457": "InvalidRecordCount",
  ...
  "0xbf961a28": "TransactionFailed",
  "0x2bb90463": "InvalidLineageIndex",
  "0x8acc5b4c": "LineageIndexAlreadySet",
  "0xdeb71313": "LineageIndexNotSet",
  "0x48a589b5": "InvalidTreeId",
  "0x494a639d": "TreeCapacityExceeded",
  "0x7d1d036f": "InvalidLeafIndex",
  "0x277cd960": "IdentityCommitmentMismatch",
  "0x368ae4c8": "UnknownPerson",
  "0x8da6a6a4": "UnknownVersion",
  "0x1355713d": "EndorsementNotIndexed",
  "0x32c967da": "InvalidConstructorAddress",
  "0xcaa03ea5": "InvalidCredential",
  "0x2c5211c6": "InvalidAmount",
  "0x625206c4": "InheritanceNotFound",
...
export const REASON_FRIENDLY_MAP: Record<string, string> = {
  ...
  InvalidGovernanceDelay: "Governance delay is invalid.",
  InvalidGovernanceMultisig: "Governance multisig address is invalid.",
  InvalidTreasuryToken: "Treasury token contract is invalid.",
  InvalidTreasuryRecipient: "Treasury recipient address is invalid.",
  VerifierRouteNotSet: "Verifier contract is not configured.",
  VerifierRouteAlreadySet: "Verifier route is already configured and cannot be replaced.",
  InvalidCircuitId: "Circuit identifier is invalid.",
  ...
  InvalidPayloadLength: "Archive payload length is invalid.",
  MetadataAlreadyStored: "Encrypted metadata has already been stored for this version.",
  StoreFailed: "Metadata Archive rejected the encrypted metadata write.",
  ...
  DirectNativeCurrencyNotAccepted: "Direct native currency transfers are not accepted.",
  StoryAlreadySealed: "Story has already been sealed.",
  StoryAlreadyInitialized: "The mint biography has already been initialized.",
  InvalidStoryAuthor: "The mint biography author is invalid.",
  RecordIndexOutOfRange: "Story record index out of range.",
  PayloadHashMismatch: "Story record payload hash mismatch.",
  ...
  NotOwner: "Current wallet is not an owner of this multisig.",
  AlreadyApproved: "Current wallet has already approved this multisig transaction.",
  TransactionAlreadyExecuted: "This multisig transaction has already been executed.",
  TransactionFailed: "Multisig transaction execution failed.",
  InvalidLineageIndex: "Lineage index contract is invalid.",
  LineageIndexAlreadySet: "Lineage index is already configured and cannot be replaced.",
  LineageIndexNotSet: "Lineage index is not configured.",
  InvalidTreeId: "Lineage tree identifier is invalid.",
  TreeCapacityExceeded: "Lineage tree has reached its maximum leaf capacity.",
  InvalidLeafIndex: "Lineage leaf index is invalid.",
  IdentityCommitmentMismatch: "Identity commitment does not match the person hash.",
  UnknownPerson: "The lineage index has no record of this person.",
  UnknownVersion: "The lineage index has no record of this version.",
  EndorsementNotIndexed: "The lineage index has no record of this endorsement.",
  InvalidConstructorAddress: "A constructor address is invalid.",
  InvalidCredential: "Inheritance credential is invalid.",
  InvalidAmount:
    "Amounts must be greater than zero, and the per-period amount must fit the contract limit.",
  InheritanceNotFound: "No inheritance exists with this id.",
  ...
  ADD_VERSION_SCOPE_CHANGED:
    "The wallet, network, DeepFamily proxy, or Reader changed. Re-enter the identity passphrases and build a new Add Version package.",
  ...
  TRANSACTION_RECEIPT_PENDING:
    "The submitted Add Version transaction is still pending. Retry without rebuilding the package.",
  TRANSACTION_RECONCILIATION_MISMATCH:
    "The transaction receipt does not match the frozen Add Version package.",
  ...
  TRANSACTION_REPLACEMENT_MISMATCH:
    "The replacement transaction differs from the frozen Add Version package and was rejected.",
