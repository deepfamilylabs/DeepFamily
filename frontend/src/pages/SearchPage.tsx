        ...
        <div className="space-y-4">
          <div className="w-full">
            <PersonHashCalculator
              ...
              identitySaltHex={hashIdentityMode === "random" ? hashRecoverySaltHex : undefined}
              onPublicFormChange={() => {
          ...
          {hashHasPassphrase && (
            <div className="rounded-2xl border border-blue-100 dark:border-blue-900/30 bg-blue-50/30 dark:bg-blue-900/10 p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={() => setHashIdentityMode("deterministic")}
                  className={`rounded-xl border px-4 py-3 text-left transition-all ${
                    hashIdentityMode === "deterministic"
              ...
              {hashIdentityMode === "random" && (
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => setHashRecoverySaltHex(generateRandomIdentitySaltHex())}
                  ...
                  <input
                    type="text"
                    value={hashRecoverySaltHex}
                    onChange={(e) => setHashRecoverySaltHex(e.target.value)}
