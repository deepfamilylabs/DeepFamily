...
export default function VisualizationPage() {
  ...
  return (
    <div className="space-y-6 text-gray-900 dark:text-gray-100 overflow-visible overflow-x-hidden">
      {SHOW_DEBUG && (() => { try { const { errors } = useTreeData(); return errors.length ? (
