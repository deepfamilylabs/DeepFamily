  ...
  return (
    <section className="py-24 lg:py-32 bg-surface relative overflow-hidden">
      <PageContainer>
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 mb-6 border border-amber-500/20">
            <Zap className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400" />
            <span className="text-sm font-bold text-amber-500 dark:text-amber-400 tracking-wide uppercase">
              Core Features
            </span>
          </div>
          ...
          <p className="text-xl text-ink-muted leading-relaxed">{t("home.features.subtitle")}</p>
        </div>
