    ...
    <section className="py-24 lg:py-32 bg-surface relative overflow-hidden">
      <PageContainer>
        ...
        >
          ...
          <p className="text-xl text-ink-muted leading-relaxed">{t("home.valueSystem.subtitle")}</p>
        </div>
            ...
            return (
              <div key={layer.key} className="group relative h-full">
                ...
                <div className="absolute inset-x-0 top-2 bottom-2 pointer-events-none">
                  ...
                  <BorderLine
                    side="right"
                    className={isLastInRow ? "bg-hairline" : "bg-transparent"}
                  />
                ...
                <div className="relative z-10 p-10 lg:p-12 h-full flex flex-col">
                  ...
                  <div className="mb-6 lg:mb-8">
                    <layer.icon className="w-10 h-10 lg:w-12 lg:h-12 text-ink-subtle group-hover:text-primary transition-colors duration-300 stroke-[1.5]" />
                  </div>

                  {/* Title */}
                  <div className="flex items-center gap-4 mb-4 lg:mb-6">
                    <span className="flex items-center justify-center w-8 h-8 rounded-full bg-surface-muted text-ink-muted font-bold text-sm group-hover:bg-orange-500/15 group-hover:text-primary transition-colors duration-300">
                      {index + 1}
                    </span>
