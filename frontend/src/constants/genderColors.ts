...
export function getGenderColor(
  ...
  switch (gender) {
    case 1: return colors.MALE
    case 2: return colors.FEMALE
    case 3: return colors.OTHER
...
export function getGenderColorHex(gender: number | undefined): string {
  switch (gender) {
    case 1: return GENDER_HEX_COLORS.MALE
    case 2: return GENDER_HEX_COLORS.FEMALE
    case 3: return GENDER_HEX_COLORS.OTHER
    default: return GENDER_HEX_COLORS.UNKNOWN
  }
}
