...
export function getFamilyTreeNodeTheme(opts: {
  ...
  const titleText: FamilyTreeThemeText = minted
    ? {
        html: "text-emerald-700 dark:text-emerald-300",
        svg: "fill-emerald-700 dark:fill-emerald-300",
      }
  ...
  const versionText: FamilyTreeThemeText = minted
    ? {
        html: "text-emerald-600 dark:text-emerald-400",
        svg: "fill-emerald-600 dark:fill-emerald-400",
      }
    : selected
