...
export default function TreeListRowRenderer(props: Omit<ListChildComponentProps<any>, 'data'> & {
  rows: TreeRow[]
  expanded: Set<NodeId>
  ...
  const { index, style, rows, expanded, toggle, rowHeight, selectedKey, nodeUiById, openNodeById, openEndorseById } = props
